...
var plotMeans = function(siteData, container, title) {
	...
	var chartOptions = {
		...
		'tooltip': {
    		'formatter': function() {
        		return '<b>Mean for Site : </b> ' + this.series.name + '<br><b>Mean Declination: </b>' + this.x.toFixed(1) + '<br><b>Mean Inclination: </b>' + this.point.inc.toFixed(1) //Tooltip on point hover. We convert the projected inclination back to the original inclination using eqAreaInv and display it to the user.
    		}
		},
		'title': {
            'text': title,
